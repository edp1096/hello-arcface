...
IMAGE_SET_URI = "https://www.robots.ox.ac.uk/~vgg/data/pets/data/images.tar.gz"
ANNOTATION_SET_URI = "https://www.robots.ox.ac.uk/~vgg/data/pets/data/annotations.tar.gz"
...
def main():
    download(IMAGE_SET_URI, DOWNLOAD_PATH)
    download(ANNOTATION_SET_URI, DOWNLOAD_PATH)
